...
function Footer({ whatsAppNumber, contactEmail, siteName }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {contactEmail && (
          <p className="mt-2 text-sm text-gray-300">
            Contact admin by email: <a href={`mailto:${contactEmail}`} className="text-blue-300 hover:text-blue-400">{contactEmail}</a>
          </p>
        )}
